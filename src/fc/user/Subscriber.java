	...
	public void update(String EVENT_TYPE, ArrayList<String> data) {
		switch(EVENT_TYPE) {
			...
			case "UPDATE_SUBSCRIBER_EVENT_TYPE":
				//data is : {"Nom", "Mot de passe", "Adresse", "Genre bloqu�", "Solde"}
			...
			case "REFOUND_TECHNICAL_EVENT_TYPE":
				//PAS s�r qu'il l� soit en r�alit� le refund c'est un trigger de bd et quand initialisation on aura la nouvelle valeur d'argent
				break;
			default:
				break;
		}
