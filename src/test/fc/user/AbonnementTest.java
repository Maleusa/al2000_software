 ...
 * @author Hugo APELOIG
 * 
 * Classe JUnit de test pour les Abonnements, Abonnement étant une classe abstraite les tests seront des tests d'héritage sur des sous
 * classes afin de vérifier la surcharge correcte 
 * 
